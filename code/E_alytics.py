...
def main():
    st.title("E-Alytics: CS2 Demos Analysis")
    ...
    st.warning("If uploading multiple matches, please make sure to upload matches from the same series/matches to avoid errors in the analysis.")
